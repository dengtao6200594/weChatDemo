...
Page({
    ...
    onReachBottom() {
        this.params.pagenum < Math.ceil(this.total / this.params.pagesize) &&
            this.params.pagenum++ &&
            getGoodsSearch(this.params).then(({ message }) => this.setData({ goodLists: [...this.data.goodLists, ...message.goods] })) ||
    ...
    onLoad: function(options) {
        ...
        this.params.cid && getGoodsSearch(this.params).then(({ message }) => {
